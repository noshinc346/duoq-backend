...
from .views import GameList, UserGameList, GameDetail, UserGameDetail, Home, UserGamesList, MakeUserGame
...
urlpatterns = [
        ...
        path('games/usergames/', MakeUserGame.as_view(), name='make-usergame'),
]
